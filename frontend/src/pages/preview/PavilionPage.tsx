...
// ── The Pavilion ──────────────────────────────────────────────────────────────
// Dark forest green · warm gold accent · DM Serif Display headlines
// Aesthetic: Lords Cricket Ground honours board meets a premium digital product.
// Traditional, authoritative, warm — not techy.
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', fontFamily: SANS }}>
      ...
      <div style={{
        ...
        <span style={{ fontFamily: SERIF, fontSize: 22, color: 'var(--accent)', letterSpacing: '0.04em' }}>
          ◈ CRICSIM
        </span>
        <div style={{ display: 'flex', gap: 24 }}>
          {['Home', 'My Stats', 'All Seasons'].map(l => (
            <span key={l} style={{ fontSize: 13, color: 'var(--text-dim)', cursor: 'pointer', fontFamily: SANS }}>
              {l}
            </span>
          ))}
        </div>
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '0 28px' }}>
        ...
        <div style={{ paddingTop: 60, paddingBottom: 48 }}>
          ...
          <p style={{
            ...
            lineHeight: 1.75, margin: '0 0 28px', maxWidth: 400,
          }}>
        ...
        {/* ── Stat strip — honours board style ── */}
        {total !== null && (
          <div style={{
            ...
            <div style={{ borderLeft: '1px solid var(--border)', paddingLeft: 28 }}>
              ...
              <div style={{ fontFamily: SANS, fontSize: 14, color: 'var(--text-muted)', lineHeight: 1.5 }}>
                Played by the CRICSIM<br />community worldwide
              </div>
            </div>
          </div>
        )}
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 52 }}>
          ...
          >
            ...
            <div style={{ fontSize: 12, fontFamily: SANS, opacity: 0.65, fontWeight: 500, letterSpacing: '0.02em' }}>
